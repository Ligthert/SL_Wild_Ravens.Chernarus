...
for "_x" from 1 to 3 do {
  ...
  _veh = (faction_mortar call BIS_fnc_selectRandom) createVehicle _pos_asset;
...
_description = "Destroy Mortars in a compound";
_title = "Destroy Mortars";
_marker_name = "Destroy Mortars";
